...
/**********************************************************************/
enum tvalues { program = 257, id, input, output, integer, real, boolean, var, begin, end, number, error};
/**********************************************************************/
...
/*
    match(var); match(id); match(','); match(id); match(','); match(id); match(',');
    match(':'); match(integer); match(';'); 
    match('$');
